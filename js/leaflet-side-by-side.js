...
var rangeCSS = document.createElement('link');
rangeCSS.setAttribute('rel', 'stylesheet');
rangeCSS.setAttribute('href', './css/range.css');
document.head.appendChild(rangeCSS);
...
window.L.Control.SideBySide = L.Control.SideBySide;
